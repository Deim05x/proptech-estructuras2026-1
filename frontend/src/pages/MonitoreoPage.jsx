    ...
    <div style={pageStyle}>
      ...
      <section style={heroStyle}>
        <div>
          ...
          <h1 style={titleStyle}>
            Centro de <span style={titleAccentStyle}>monitoreo</span>
          </h1>
      ...
      <section style={summaryGridStyle}>
        <InfoCard
          icono="🚨"
          titulo="Alertas"
          texto="Seguimiento de eventos críticos y pendientes."
        />

        <InfoCard
          icono="📊"
          titulo="Eventos"
          texto="Detección de situaciones inusuales del sistema."
        />
...
const pageStyle = {
  ...
  animation: "fadeUpMonitoreo 0.55s ease both",
};
...
const heroBadgeDotStyle = {
  ...
  animation: "pulseMonitoreo 1.8s ease-in-out infinite",
};
...
const infoIconStyle = {
  ...
  fontSize: "1.45rem",
  animation: "glowMonitoreo 3.3s ease-in-out infinite",
};
