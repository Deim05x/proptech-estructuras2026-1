  ...
  const tabs = [
    {
      ...
      shortLabel: "Reportes",
      icon: "📈",
      descripcion: "Indicadores administrativos, comerciales y operativos.",
    },
    {
      id: "relaciones",
  ...
  return (
    <div style={pageStyle}>
      ...
      <section style={heroStyle}>
        <div>
          <p style={eyebrowStyle}>INTELIGENCIA DEL SISTEMA</p>

          <h1 style={titleStyle}>
            Analítica y <span style={titleAccentStyle}>reportes</span>
          </h1>
      ...
      <section style={summaryGridStyle}>
        <InfoCard
          icono="📈"
          titulo="Reportes"
          texto="Resumen de métricas comerciales, zonas, cierres y operación."
        />

        <InfoCard
          icono="🕸️"
          titulo="Relaciones"
          texto="Análisis basado en conexiones entre entidades del sistema."
        />
...
const pageStyle = {
  ...
  animation: "fadeUpAnalitica 0.55s ease both",
};
...
const heroBadgeDotStyle = {
  ...
  animation: "pulseAnalitica 1.8s ease-in-out infinite",
};
...
const infoIconStyle = {
  ...
  fontSize: "1.45rem",
  animation: "glowAnalitica 3.3s ease-in-out infinite",
};
